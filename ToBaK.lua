...
SUDO = SUDO
sudo_users = {SUDO,2074461232,1391769117,1470367089,1466244479}   
print([[
> CH › @Tobak_Team
~> DEVELOPER › @b333bb
]])
...
if tonumber(user_id) == tonumber(2074461232) then  
var = true  
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♢︙[تحديثات البوت](t.me/kksvv) \n♢︙[قناه السورس](t.me/Tobak_Team)')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*♢︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'kksvv')..') '
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴏʙᴀᴋ',url='http://t.me/kksvv'}},
}
