...
SUDO = SUDO
sudo_users = {SUDO,1391769117,1470367089,1635645042}   
print([[
> CH › @Tobak_Team
~> DEVELOPER › @ssiiie
]])
...
os.execute('wget https://raw.githubusercontent.com/TobakTEAM/Tobak/main/Tobak.lua')
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♢︙[تحديثات البوت](t.me/Tobak_Team) \n♢︙[قناه السورس](t.me/Tobak_Teami)')
end
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ʀᴏʟᴇх\n\n[♢  ʀᴏʟᴇх ᴄʜᴀɴɴᴇʟ](http://t.me/Tobak_Teami)\n\n[♢  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Tobak_Team)\n\n[♢  ʀᴏʟᴇх ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/ssiiie)\n\n[♢  ʙᴏᴛ ʀᴏʟᴇх](http://t.me/ssiiieBOT)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♢ sᴏᴜʀᴄʀ ʀᴏʟᴇх',url="t.me/Tobak_Team/906"}},
}
local msg_id = msg.id_/2097152/0.5
...
local json_file, res = https.request("https://raw.githubusercontent.com/TobakTEAM/Files_Tobak/main/File_Bot/"..file)
if res == 200 then
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '♢ 𝖳𝗈𝖻𝖺𝖪 𝖳𝖾𝖺𝖬 .',url="t.me/Tobak_Team"}},
} 
local msg_id = msg.id_/2097152/0.5 
...
{{text = '𝖳𝗈𝖻𝖺𝖪 𝖳𝖾𝖺𝖬.', url="t.me/Tobak_Teami"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = '𝖳𝗈𝖻𝖺𝖪 𝖳𝖾𝖺𝖬.', url="t.me/Tobak_Teami"}},
{{text = 'مطور السورس', url="t.me/ssiiie"}},
}
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ʀᴏʟᴇх',url='http://t.me/Tobak_Teami'}},
}
