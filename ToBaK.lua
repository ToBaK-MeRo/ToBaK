...
SUDO = SUDO
sudo_users = {SUDO,1445010567,1391769117,1466244479}   
print([[
> CH › @Tobak_Team
~> DEVELOPER › @C777C
]])
...
if tonumber(user_id) == tonumber(1445010567) then  
var = true  
...
var = true 
elseif tonumber(user_id) == tonumber(2010087512) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@C777C")  
...
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♢︙[تحديثات البوت](t.me/EE333E) \n♢︙[قناه السورس](t.me/Tobak_Team)')
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*♢︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'EE333E')..') '
...
{{text = '𝐓𝐎𝐁𝐀𝐊 𝐓𝐄𝐀𝐌', url="t.me/EE333E"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴏʙᴀᴋ',url='http://t.me/EE333E'}},
}
