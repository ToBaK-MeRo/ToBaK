...
local RunBot = io.open("ToBaK", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/ToBaK
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr ToBaK.lua
wget "https://raw.githubusercontent.com/ToBaK-MeRo/ToBaK/main/ToBaK.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./ToBaK.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S ToBaK -X kill
screen -S ToBaK ./ToBaK
done
]])
RunTs:close()
end
