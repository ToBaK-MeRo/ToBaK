...
SUDO = SUDO
sudo_users = {SUDO,1635645042,1391769117,1470367089}   
print([[
> CH › @Tobak_Team
~> DEVELOPER › @uGGGu
]])
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ToBaK-MeRo/Files_ToBaK/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevToBaKW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
local UserName = (data.username_ or "Tobak_Team")
...
local ToBaK_Msg = ''  
if msgs < 100 then 
ToBaK_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
ToBaK_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
ToBaK_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
ToBaK_Msg = 'متفاعل' 
elseif msgs < 1200 then 
ToBaK_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
ToBaK_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
ToBaK_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
ToBaK_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
ToBaK_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
ToBaK_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
ToBaK_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
ToBaK_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
ToBaK_Msg = 'رب التفاعل'  
end 
return ToBaK_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@uGGGu")  
...
--------------------------------------------------------------------------------------------------------------
function SourceToBaK(msg,data) -- بداية العمل امـيـر الـ دلـيـم
if msg then
...
local list = database:smembers(bot_id.."ToBaK1:List:Filter"..sl)
...
if not DevToBaKW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevToBaKW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,ToBaK_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ♢' and DevToBaKW(msg) then  
...
if text == 'تعطيل التواصل ♢' and DevToBaKW(msg) then  
...
if text == 'تفعيل البوت الخدمي ♢' and DevToBaKW(msg) then  
...
if text == 'تعطيل البوت الخدمي ♢' and DevToBaKW(msg) then  
...
if text == 'ضع كليشه ستارت ♢' and DevToBaKW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *♢︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ♢' and DevToBaKW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *♢︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ♢' and DevToBaKW(msg) then 
...
if text == 'تحديث السورس ♢' and DevToBaKW(msg) then 
os.execute('rm -rf ToBaK.lua')
os.execute('wget https://raw.githubusercontent.com/ToBaK-MeRo/ToBaK/main/ToBaK.lua')
send(msg.chat_id_, msg.id_,' *♢︙تم تحديث السورس* \n*♢︙لديك اخر اصدار لسورس توباك*\n*♢︙الاصدار » { 2.8v}*')
dofile('ToBaK.lua')  
end
if text == 'الاصدار ♢' and DevToBaKW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *♢︙اصدار سورس توباك* \n*♢︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ♢' and DevToBaKW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ♢︙[تحديثات البوت](t.me/ToBaK_TeAmi) \n♢︙[قناه السورس](t.me/Tobak_Team)')
end
if text == "ضع اسم للبوت ♢" and DevToBaKW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *♢︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ♢' and DevToBaKW(msg) then 
...
if text == 'المشتركين ♢' and DevToBaKW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *♢︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ♢' and DevToBaKW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *♢︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ♢") and DevToBaKW(msg) then
...
if text == ("قائمه العام ♢") and DevToBaKW(msg) then
...
if text == ("قائمه الكتم العام ♢") and DevToBaKW(msg) then
...
if text=="اذاعه خاص ♢" and msg.reply_to_message_id_ == 0 and DevToBaKW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♢︙ارسل الان اذاعتك؟* \n*♢︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ♢" and msg.reply_to_message_id_ == 0 and DevToBaKW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♢︙ارسل الان اذاعتك؟* \n*♢︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ♢" and msg.reply_to_message_id_ == 0 and DevToBaKW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♢︙ارسل الان اذاعتك؟* \n*♢︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ♢" and msg.reply_to_message_id_ == 0  and DevToBaKW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *♢︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ♢" and msg.reply_to_message_id_ == 0  and DevToBaKW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ♢︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ♢' and DevToBaKW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ♢" and DevToBaKW(msg) then
...
if text == "تنظيف الكروبات ♢" and DevToBaKW(msg) then 
...
send(msg.chat_id_, msg.id_,'*♢︙عدد الكروبات الان » { '..#group..' }'..ToBaKk..''..ToBaK..'*\n*♢︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevToBaKW(msg) then
...
usertext = '*\n ♢︙اسم المستخدم »* ['..result.title_..'](t.me/'..(username or 'Tobak_Team')..')'
status  = '\n *♢︙تم ترقيته مطور*'
...
if text and text:match("^رفع مطور (%d+)$") and DevToBaKW(msg) then
local userid = text:match("^رفع مطور (%d+)$")
database:sadd(bot_id..'Sudo:User', userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *♢︙اسم المستخدم »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Tobak_Team')..')'
status  = '\n*♢︙تم ترقيته مطور*'
...
if text and text:match("^تنزيل مطور @(.*)$") and DevToBaKW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevToBaKW(msg) then
...
local ToBaK1_Msg = database:get(bot_id.."ToBaK1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ToBaK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *♢︙اسم المستخدم »* ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Tobak_Team')..') \n ♢︙'..ToBaK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ToBaK_Msg and not Special(msg) then  
local ToBaK_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ToBaK_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *♢︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n♢︙["..ToBaK_Msg.."] \n")
else
send(msg.chat_id_,0," *♢︙العضو :* {["..data.first_name_.."](T.ME/Tobak_Team)}\n♢︙["..ToBaK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
...
send(msg.chat_id_,0, " *♢︙عذرا ↫* {["..data.first_name_.."](T.ME/Tobak_Team)}\n*♢︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevToBaKW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevToBaKW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevToBaKW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *♢︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevToBaKW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *♢︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ♢" and DevToBaKW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *♢︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ♢$") and DevToBaKW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *♢︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ♢" and DevToBaKW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ♢" and DevToBaKW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *♢︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ♢" and DevToBaKW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."ToBaK:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."ToBaK:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_ToBaK = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_ToBaK then 
names_ToBaK = database:smembers(bot_id.."ToBaK:blocname"..msg.chat_id_) or ""
if names_ToBaK and names_ToBaK[1] then 
for i=1,#names_ToBaK do 
if name_ToBaK:match("(.*)("..names_ToBaK[i]..")(.*)") then 
...
database:set(bot_id.."ToBaK:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."ToBaK:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."ToBaK:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."ToBaK:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."ToBaK:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_ToBaKa_new(ToBaK1,ToBaK2)
if ToBaK2 and ToBaK2.first_name_ then 
if ToBaK2.first_name_:match("(.*)"..database:get(bot_id.."ToBaK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ToBaK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local ToBaK_nnn = database:get(bot_id.."ToBaK:nump"..msg.chat_id_) or 5
local ToBaK_nnn2 = database:get(bot_id.."ToBaK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(ToBaK_nnn2) == tonumber(ToBaK_nnn) or tonumber(ToBaK_nnn2) > tonumber(ToBaK_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."ToBaK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "♢︙عزيزي >>["..ToBaK2.username_.."](https://t.me/"..(ToBaK2.username_ or "Tobak_Team")..")\n♢︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ToBaK:teh"..msg.chat_id_).."} بجانب اسمك\n♢︙عدد المحاولات المتبقيه {"..(tonumber(ToBaK_nnn) - tonumber(ToBaK_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_ToBaKa_new)
end
end
...
local ToBaKChengName = database:get(bot_id.."ToBaK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if ToBaKChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ToBaKChengName..']')
database:del(bot_id.."ToBaK:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if ToBaKChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."ToBaK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local ToBaKChengUserName = database:get(bot_id.."ToBaK:Cheng:UserName"..data.id_)
if not data.username_ then 
if ToBaKChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..ToBaKChengUserName..']')
database:del(bot_id.."ToBaK:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if ToBaKChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."ToBaK:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local ToBaKChengPhoto = database:get(bot_id.."ToBaK:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if ToBaKChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."ToBaK:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if ToBaKChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."ToBaK:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ sᴏᴜʀᴄʀ ᴛᴏʙᴀᴋ\n\n[♢  ᴛᴏʙᴀᴋ ᴄʜᴀɴɴᴇʟ](http://t.me/ToBaK_TeAmi)\n\n[♢  ɪɴғᴏ sᴏᴜʀᴄᴇ](http://t.me/Tobak_Team)\n\n[♢  ᴛᴏʙᴀᴋ ᴅᴇᴠᴇʟᴏᴘᴇʀ](http://t.me/uGGGu)\n\n[♢  ʙᴏᴛ ᴛᴏʙᴀᴋ](http://t.me/ugggubot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '♢ sᴏᴜʀᴄʀ ᴛᴏʙᴀᴋ',url="t.me/Tobak_Team/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/Tobak_Team&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevToBaKW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
send(msg.chat_id_, msg.id_, '*♢︙بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'Tobak_Team')..') \n*♢︙تم تفعيل التنظيف التلقائي* ')
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *♢︙بواسطه »* ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'Tobak_Team')..') \n*♢︙تـم قفـل التاك بالكتم* ')
end,nil)   
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevToBaKW(msg) then
dofile('ToBaK.lua')  
send(msg.chat_id_, msg.id_, ' *♢︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevToBaKW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevToBaKW(msg) then  
function start_function(extra, result, success)
if ToBaKSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevToBaKW(msg) then  
...
if ToBaKSudoBot(result.id_) then
send(msg.chat_id_, msg.id_,"*♢︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text and text:match("^حظر عام (%d+)$") and DevToBaKW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if ToBaKSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*♢︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevToBaKW(msg) then  
function start_function(extra, result, success)
if ToBaKSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*♢︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevToBaKW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevToBaKW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if ToBaKSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*♢︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevToBaKW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevToBaKW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevToBaKW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevToBaKW(msg) then
...
if text == 'الملفات' and DevToBaKW(msg) then
t = ' *♢︙ملفات السورس توباك ↓*\n*•━━━━━━ 𝙏𝙆 ━━━━━━━•* \n'
i = 0
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
i = i + 1
...
if DevToBaKW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ToBaK-MeRo/Files_ToBaK/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *♢︙اهلا بك في متجر ملفات توباك*\n*♢︙ملفات السورس ↓*\n*•━━━━━━ 𝙏𝙆 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝙏𝙆 ━━━━━━━•*\n *♢︙علامة تعني { ✓ } ملف مفعل*\n *♢︙علامة تعني { ✘ } ملف معطل*\n *♢︙قناة سورس توباك ↓*\n".." *♢︙*[اضغط هنا لدخول](t.me/Tobak_Team) \n"
local NumFile = 0
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevToBaKW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/ToBaK-MeRo/Files_ToBaK/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ToBaK.lua')  
else
send(msg.chat_id_, msg.id_," *♢︙عذرا الملف لايدعم سورس توباك* \n") 
end
return false
end
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevToBaKW(msg) then
...
if text == "مسح الملفات" and DevToBaKW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *♢︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevToBaKW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevToBaKW(msg) then  
function start_function(extra, result, success)
...
function Function_ToBaK(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_ToBaK, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_ToBaK, nil)
return false 
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *♢︙العضو* » ['..data.first_name_..'](t.me/'..(data.username_ or 'Tobak_Team')..')'
status  = '\n*♢︙تم ترقيته ادمن*'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n *♢︙لعضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Tobak_Team')..')'
status  = '\n*♢︙تم تنزيله من المميزين*'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n *♢︙اسم المستخدم »* '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n *♢︙العضــو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'Tobak_Team')..')'
...
database:set(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *♢︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ToBaK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ToBaK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *♢︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ToBaK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ToBaK1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ToBaK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *♢︙ارسل الكلمه الان*")  
database:set(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ToBaK1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ToBaK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ToBaK1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ToBaK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ToBaK1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ToBaK1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevToBaKW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *♢︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevToBaKW(msg) then
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n *♢︙اسم المستخدم »* ['..result.title_..'](t.me/'..(text1[3] or 'Tobak_Team')..')'..'\n*♢︙تم رفعه '..text1[2]..'*')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == 'تفعيل الاذاعه' and DevToBaKW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevToBaKW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..ToBaK_Msg[math.random(#ToBaK_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevToBaKW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,ToBaK)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ 𝙏𝙆 ━━━━━━━•*\n"
x = 0
local list = ToBaK.members_
for k, v in pairs(list) do
x = x + 1
...
if ToBaKSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevToBaKW(msg) then 
...
if text == ("ردود المطور") and DevToBaKW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ♢︙قائمة ردود المطور \n*•━━━━━━ 𝙏𝙆 ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevToBaKW(msg) then    
send(msg.chat_id_, msg.id_,' *♢︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevToBaKW(msg) then    
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'توباك').." غادر" or text == 'غادر' then  
...
if text == 'تفعيل المغادره' and DevToBaKW(msg) then   
...
if text == 'تعطيل المغادره' and DevToBaKW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*♢︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'ToBaK_TeAmi')..') '
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'Tobak_Team')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
ToBaKdx(msg.chat_id_, msg.id_, ' *♢︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*♢︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*♢︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*♢︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevToBaKW(msg) then
...
{{text = '𝐓𝐎𝐁𝐀𝐊 𝐓𝐄𝐀𝐌', url="t.me/ToBaK_TeAmi"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
GetDo = https.request('https://vvvzvv.ml/azlmem/up.php?Type=ins&url='..URL.escape(Textm))
...
GetDo = https.request('https://vvvzvv.ml/azlmem/st.php?username='..URL.escape(Textm))
DoGet = JSON.decode(GetDo)
...
GetDo = https.request('https://vvvzvv.ml/azlmem/up.php?Type=sc&url='..URL.escape(Textm))
DoGet = JSON.decode(GetDo)
if DoGet.link ~= false then 
local msg_id = msg.id_/2097152/0.5
...
GetDo = https.request('https://vvvzvv.ml/azlmem/tiktok.php?u='..URL.escape(Textm))
DoGet = JSON.decode(GetDo)
if DoGet.link ~= false then 
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendVideo?chat_id=' .. msg.chat_id_ .. '&video='..URL.escape(DoGet.link)..'&caption=*♢︙تم التحميل بنجاح .✅*&reply_to_message_id='..msg_id.."&parse_mode=markdown&disable_web_page_preview=true")
...
send(msg.chat_id_, msg.id_, t..'ٴ♢∫ٴ*•━━━━━━ 𝙏𝙆 ━━━━━━━•*ٴ♢∫○ٴ\n♢︙[𝐓𝐎𝐁𝐀𝐊 𝐓𝐄𝐀𝐌](t.me/Tobak_Team) ')
end
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝖳𝗈𝖡𝖺𝖪 𝘛𝘦𝘈𝘮',url="t.me/Tobak_Team"}},
}
local msg_id = msg.id_/2097152/0.5
...
{{text = '♢︙ 𝖳𝗈𝖡𝖺𝖪 𝘛𝘦𝘈𝘮  .',url='http://t.me/Tobak_Team'}},
}
...
inline = {
{{text = 'sᴏᴜʀᴄʀ ᴛᴏʙᴀᴋ',url='http://t.me/ToBaK_TeAmi'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
ToBaK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ToBaK)
...
--------------------------------------------------------------------------------------------------------------
SourceToBaK(data.message_,data)
...
------------------------------------------------------------------------
local ToBaKAbot = database:get(bot_id.."ToBaK1:Add:Filter:Rp2"..text..result.chat_id_)   
if ToBaKAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *♢︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n♢︙["..ToBaKAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ToBaK1_Msg = database:get(bot_id.."ToBaK1:Add:Filter:Rp2"..text..result.chat_id_)   
if ToBaK1_Msg then
send(msg.chat_id_, msg.id_," ♢︙"..ToBaK1_Msg)
